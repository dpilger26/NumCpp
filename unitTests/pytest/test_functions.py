...
def test_functions():
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert NumCpp.average(cArray, NumCpp.Axis.NONE).item() == np.average(data)
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.average(cArray, NumCpp.Axis.ROW).flatten(), np.average(data, axis=0))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.average(cArray, NumCpp.Axis.COL).flatten(), np.average(data, axis=1))
    ...
    assert NumCpp.averageWeighted(cArray, cWeights, NumCpp.Axis.NONE).item() == np.average(data, weights=weights)
    ...
    cArray.setArray(data)
    cWeights.setArray(weights)
    assert np.array_equal(NumCpp.averageWeighted(cArray, cWeights, NumCpp.Axis.ROW).flatten(),
                          np.average(data, weights=weights.flatten(), axis=0))
    ...
    cWeights.setArray(weights)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.averageWeighted(cArray, cWeights, NumCpp.Axis.COL).flatten(),
                          np.average(data, weights=weights.flatten(), axis=1))
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.cumprod(cArray, NumCpp.Axis.NONE).flatten().astype(np.uint32), data.cumprod())
    ...
    data = np.random.randint(1, 4, [shape.rows, shape.cols], dtype=np.uint32)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.cumprod(cArray, NumCpp.Axis.ROW).astype(np.uint32), data.cumprod(axis=0))
    ...
    data = np.random.randint(1, 4, [shape.rows, shape.cols], dtype=np.uint32)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.cumprod(cArray, NumCpp.Axis.COL).astype(np.uint32), data.cumprod(axis=1))
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.cumsum(cArray, NumCpp.Axis.NONE).flatten().astype(np.uint32), data.cumsum())
    ...
    data = np.random.randint(1, 50, [shape.rows, shape.cols], dtype=np.uint32)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.cumsum(cArray, NumCpp.Axis.ROW).astype(np.uint32), data.cumsum(axis=0))
    ...
    data = np.random.randint(1, 50, [shape.rows, shape.cols], dtype=np.uint32)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.cumsum(cArray, NumCpp.Axis.COL).astype(np.uint32), data.cumsum(axis=1))
    ...
    assert np.array_equal(NumCpp.diagonal(cArray, offset, NumCpp.Axis.ROW).astype(np.uint32).flatten(),
    ...
    cArray.setArray(data)
    offset = np.random.randint(0, min(shape.rows, shape.cols), [1, ]).item()
    assert np.array_equal(NumCpp.diagonal(cArray, offset, NumCpp.Axis.COL).astype(np.uint32).flatten(),
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.diff(cArray, NumCpp.Axis.NONE).flatten().astype(np.uint32),
    ...
    data = np.random.randint(1, 50, [shape.rows, shape.cols]).astype(np.uint32)
    cArray.setArray(data)
    assert np.array_equal(NumCpp.diff(cArray, NumCpp.Axis.ROW).astype(np.uint32), np.diff(data, axis=0))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert NumCpp.dot(cArray1, cArray2).astype(np.uint32).item() == np.dot(data1, data2.T).item()
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.dot(cArray1, cArray2).astype(np.uint32), np.dot(data1, data2))
    ...
    cArray.setArray(data)
    assert np.array_equal(NumCpp.gradient(cArray, NumCpp.Axis.ROW).getNumpyArray(), np.gradient(data, axis=0))
    ...
    data = np.random.randint(1, 1000, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.gradient(cArray, NumCpp.Axis.COL).getNumpyArray(), np.gradient(data, axis=1))
    ...
    data = np.random.randint(1, 1000, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.gradient(cArray, NumCpp.Axis.NONE).getNumpyArray().flatten(),
    ...
    assert (NumCpp.hypotScalerTriple(value1, value2, value3) ==
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.matmul(cArray1, cArray2).getNumpyArray(), np.matmul(data1, data2))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.max(cArray, NumCpp.Axis.ROW).getNumpyArray().astype(np.uint32).flatten(),
                          np.max(data, axis=0))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.max(cArray, NumCpp.Axis.COL).getNumpyArray().astype(np.uint32).flatten(),
                          np.max(data, axis=1))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.maximum(cArray1, cArray2).getNumpyArray(), np.maximum(data1, data2))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert NumCpp.mean(cArray, NumCpp.Axis.NONE).getNumpyArray().flatten().item() == np.mean(data, axis=None).item()
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.mean(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(), np.mean(data, axis=0))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.mean(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(), np.mean(data, axis=1))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.min(cArray, NumCpp.Axis.ROW).getNumpyArray().astype(np.uint32).flatten(),
                          np.min(data, axis=0))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.min(cArray, NumCpp.Axis.COL).getNumpyArray().astype(np.uint32).flatten(),
                          np.min(data, axis=1))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.minimum(cArray1, cArray2).getNumpyArray(), np.minimum(data1, data2))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.multiply(cArray1, cArray2).getNumpyArray(), np.multiply(data1, data2))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(NumCpp.outer(cArray1, cArray2).astype(np.uint32), np.outer(data1, data2))
    ...
    cArray.setArray(data)
    assert NumCpp.ptp(cArray, NumCpp.Axis.NONE).getNumpyArray().astype(np.uint32).item() == data.ptp()
    ...
    cArray.setArray(data)
    assert np.array_equal(np.round(NumCpp.reciprocal(cArray).getNumpyArray(), 9), np.round(np.reciprocal(data), 9))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert (NumCpp.rms(cArray, NumCpp.Axis.NONE).getNumpyArray().flatten().item() ==
            np.sqrt(np.mean(np.square(data), axis=None)).item())
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.rms(cArray, NumCpp.Axis.ROW).getNumpyArray().flatten(),
                          np.sqrt(np.mean(np.square(data), axis=0)))
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols])
    cArray.setArray(data)
    assert np.array_equal(NumCpp.rms(cArray, NumCpp.Axis.COL).getNumpyArray().flatten(),
                          np.sqrt(np.mean(np.square(data), axis=1)))
    ...
    # assert np.array_equal(NumCpp.triuRect(shapeInput[0].item(), shapeInput[1].item(), offset),
    #                   np.tri(shapeInput[0].item(), shapeInput[1].item(), k=-offset)):
