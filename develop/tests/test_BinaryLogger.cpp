...
#include "ball/common/utils/logger/BinaryLogger.h"

namespace ball::common::utils::logger
{
	class BinaryLoggerTestSuite : public BaseTest
	{
	};
	...
	public:
		...
		BaseDataType(int a, double b, bool c, char d) noexcept : a_(a), b_(b), c_(c), d_(d)
		{
		}
	...
	public:
		...
		explicit SerialDataType(std::size_t size) : size_(size), data_(size)
		{
		}
