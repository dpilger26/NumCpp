...
void initCoordinates(pb11::module& m)
{
    ...
    pb11::class_<coordinates::Cartesian>(m, "Cartesian")
        ...
        .def("toNdArray", &coordinates::Cartesian::toNdArray)
    ...
    pb11::class_<coordinates::Euler>(m, "Euler")
        ...
        .def("toNdArray", &coordinates::Euler::toNdArray)
    ...
    pb11::class_<coordinates::Orientation>(m, "Orientation")
        ...
        .def("toNdArray", &coordinates::Orientation::toNdArray)
        .def("__eq__",
    ...
    pb11::class_<coordinates::reference_frames::AER>(m, "AER")
        ...
        .def("toNdArray", &coordinates::reference_frames::AER::toNdArray)
        .def("__eq__",
    ...
    pb11::class_<coordinates::reference_frames::Geocentric>(m, "Geocentric")
        ...
        .def("toNdArray", &coordinates::reference_frames::Geocentric::toNdArray)
        .def("__eq__",
    ...
    pb11::class_<coordinates::reference_frames::LLA>(m, "LLA")
        ...
        .def("toNdArray", &coordinates::reference_frames::LLA::toNdArray)
        .def("__eq__",
