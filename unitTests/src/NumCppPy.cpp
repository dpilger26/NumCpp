...
BOOST_PYTHON_MODULE(NumCpp)
{
    ...
    bp::class_<NdArrayDouble>
        ...
        .def("operatorPlusScaler", &NdArrayInterface::operatorPlusScaler<std::complex<double>>)
        .def("operatorPlusScalerReversed", &NdArrayInterface::operatorPlusScalerReversed<double>)
        .def("operatorPlusScalerReversed", &NdArrayInterface::operatorPlusScalerReversed<std::complex<double>>)
        .def("operatorPlusArray", &NdArrayInterface::operatorPlusArray<double>)
        .def("operatorPlusArray", &NdArrayInterface::operatorPlusArray<std::complex<double>>)
        .def("operatorNegative", &NdArrayInterface::operatorNegative<std::complex<double>>)
        .def("operatorNegative", &NdArrayInterface::operatorNegative<double>)
        .def("operatorMinusScaler", &NdArrayInterface::operatorMinusScaler<std::complex<double>>)
        ...
        .def("operatorMinusScalerReversed", &NdArrayInterface::operatorMinusScalerReversed<std::complex<double>>)
        .def("operatorMinusArray", &NdArrayInterface::operatorMinusArray<double>)
        .def("operatorMinusArray", &NdArrayInterface::operatorMinusArray<std::complex<double>>)
        .def("operatorMultiplyScaler", &NdArrayInterface::operatorMultiplyScaler<double>)
        .def("operatorMultiplyScaler", &NdArrayInterface::operatorMultiplyScaler<std::complex<double>>)
        .def("operatorMultiplyScalerReversed", &NdArrayInterface::operatorMultiplyScalerReversed<double>)
        .def("operatorMultiplyScalerReversed", &NdArrayInterface::operatorMultiplyScalerReversed<std::complex<double>>)
        .def("operatorMultiplyArray", &NdArrayInterface::operatorMultiplyArray<double>)
        .def("operatorMultiplyArray", &NdArrayInterface::operatorMultiplyArray<std::complex<double>>)
        .def("operatorDivideScaler", &NdArrayInterface::operatorDivideScaler<double>)
        .def("operatorDivideScaler", &NdArrayInterface::operatorDivideScaler<std::complex<double>>)
        .def("operatorDivideScalerReversed", &NdArrayInterface::operatorDivideScalerReversed<double>)
        .def("operatorDivideScalerReversed", &NdArrayInterface::operatorDivideScalerReversed<std::complex<double>>)
        .def("operatorDivideArray", &NdArrayInterface::operatorDivideArray<double>)
        .def("operatorDivideArray", &NdArrayInterface::operatorDivideArray<std::complex<double>>)
        .def("operatorEquality", &NdArrayInterface::operatorEqualityScaler<double>)
        .def("operatorEquality", &NdArrayInterface::operatorEqualityScaler<std::complex<double>>)
        .def("operatorEqualityReversed", &NdArrayInterface::operatorEqualityScalerReversed<double>)
        .def("operatorEqualityReversed", &NdArrayInterface::operatorEqualityScalerReversed<std::complex<double>>)
        .def("operatorEquality", &NdArrayInterface::operatorEqualityArray<double>)
        .def("operatorEquality", &NdArrayInterface::operatorEqualityArray<std::complex<double>>)
        .def("operatorNotEquality", &NdArrayInterface::operatorNotEqualityScaler<double>)
        .def("operatorNotEquality", &NdArrayInterface::operatorNotEqualityScaler<std::complex<double>>)
        .def("operatorNotEqualityReversed", &NdArrayInterface::operatorNotEqualityScalerReversed<double>)
        .def("operatorNotEqualityReversed", &NdArrayInterface::operatorNotEqualityScalerReversed<std::complex<double>>)
        .def("operatorNotEquality", &NdArrayInterface::operatorNotEqualityArray<double>)
        .def("operatorNotEquality", &NdArrayInterface::operatorNotEqualityArray<std::complex<double>>)
        .def("operatorLess", &NdArrayInterface::operatorLessScaler<double>)
        .def("operatorLess", &NdArrayInterface::operatorLessScaler<std::complex<double>>)
        .def("operatorLessReversed", &NdArrayInterface::operatorLessScalerReversed<double>)
        .def("operatorLessReversed", &NdArrayInterface::operatorLessScalerReversed<std::complex<double>>)
        .def("operatorLess", &NdArrayInterface::operatorLessArray<double>)
        .def("operatorLess", &NdArrayInterface::operatorLessArray<std::complex<double>>)
        .def("operatorGreater", &NdArrayInterface::operatorGreaterScaler<double>)
        .def("operatorGreater", &NdArrayInterface::operatorGreaterScaler<std::complex<double>>)
        .def("operatorGreaterReversed", &NdArrayInterface::operatorGreaterScalerReversed<double>)
        .def("operatorGreaterReversed", &NdArrayInterface::operatorGreaterScalerReversed<std::complex<double>>)
        .def("operatorGreater", &NdArrayInterface::operatorGreaterArray<double>)
        .def("operatorGreater", &NdArrayInterface::operatorGreaterArray<std::complex<double>>)
        .def("operatorLessEqual", &NdArrayInterface::operatorLessEqualScaler<double>)
        .def("operatorLessEqual", &NdArrayInterface::operatorLessEqualScaler<std::complex<double>>)
        .def("operatorLessEqualReversed", &NdArrayInterface::operatorLessEqualScalerReversed<double>)
        .def("operatorLessEqualReversed", &NdArrayInterface::operatorLessEqualScalerReversed<std::complex<double>>)
        .def("operatorLessEqual", &NdArrayInterface::operatorLessEqualArray<double>)
        .def("operatorLessEqual", &NdArrayInterface::operatorLessEqualArray<std::complex<double>>)
        .def("operatorGreaterEqual", &NdArrayInterface::operatorGreaterEqualScaler<double>)
        .def("operatorGreaterEqual", &NdArrayInterface::operatorGreaterEqualScaler<std::complex<double>>)
        .def("operatorGreaterEqualReversed", &NdArrayInterface::operatorGreaterEqualScalerReversed<double>)
        .def("operatorGreaterEqualReversed", &NdArrayInterface::operatorGreaterEqualScalerReversed<std::complex<double>>)
        .def("operatorGreaterEqual", &NdArrayInterface::operatorGreaterEqualArray<double>)
        .def("operatorGreaterEqual", &NdArrayInterface::operatorGreaterEqualArray<std::complex<double>>)
