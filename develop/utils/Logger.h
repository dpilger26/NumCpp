...
namespace chimera::algs::common::utils::logger
{
	/**
	...
	[[nodiscard]] inline BOOST_LOG_GLOBAL_LOGGER_INIT(fileLogger, boost::log::sources::severity_logger_mt)
	{
		...
		detail::sinkConsole->locked_backend()->add_stream(boost::shared_ptr<std::ostream>(&std::clog, boost::null_deleter()));
...
#define BOOST_CHIMERA_LOGGER(severity)                                                                    \
	BOOST_LOG_SEV(chimera::algs::common::utils::logger::fileLogger::get(), boost::log::trivial::severity) \
		<< boost::log::add_value("Filename", std::filesystem::path(__FILE__).filename().stem().string())  \
		<< boost::log::add_value("FunctionName", __FUNCTION__) << boost::log::add_value("LineNumber", uint32_t{__LINE__})

// ===== log macros =====
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define LOG_TRACE BOOST_CHIMERA_LOGGER(trace)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define LOG_DEBUG BOOST_CHIMERA_LOGGER(debug)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define LOG_INFO BOOST_CHIMERA_LOGGER(info)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define LOG_WARNING BOOST_CHIMERA_LOGGER(warning)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define LOG_ERROR BOOST_CHIMERA_LOGGER(error)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define LOG_FATAL BOOST_CHIMERA_LOGGER(fatal)
