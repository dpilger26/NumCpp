...
namespace nc::coordinates::transforms
{
    namespace reference_frames
    {
        ...
        {
            os << "LLA(latitude=" << point.latitude() << ", longitude=" << point.longitude()
        ...
        public:
             ...
             */
            ECEF(const Cartesian& cartesian)
            noexcept :
                Cartesian(cartesian)
            {
            }
    ...
    namespace transforms
    {
         ...
         */
        [[nodiscard]] inline reference_frames::LLA ECEFtoLLA(const reference_frames::ECEF& ecef,
                                                             ...
                                                             const reference_frames::LLA&  platform) noexcept
        {
            ...
            return reference_frames::ENU{ -sinLon * x + cosLon * y,
        ...
        [[nodiscard]] inline reference_frames::AzEl
            ECEFtoAzElGeocentric(const reference_frames::ECEF& target, const reference_frames::ECEF& platform) noexcept
        {
            ...
            return reference_frames::AzEl{ Wrap2Pi(std::atan2(rhoHat * eHat, rhoHat * nHat)),
                                           std::asin(rhoHat * uHat) };
        }
         ...
         * @return NED
         */
        [[nodiscard]] inline reference_frames::NED InertialToCart(const types::Point2dInertial inertial,
        ...
        namespace detail
        {
             ...
             */
            [[nodiscard]] inline std::array<types::Vec3, 3>
                NEDUnitVecsInECEF(const reference_frames::ECEF& location) noexcept
            {
