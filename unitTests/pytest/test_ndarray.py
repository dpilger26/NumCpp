...
def test_ndarray():
    ...
    assert np.array_equal(cArray.operatorPlusScaler(randScaler), data + randScaler)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorPlusScalerReversed(randScaler), data + randScaler)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorPlusArray(cArray2), data1 + data2)
    ...
    data = np.random.randint(0, 100, [shape.rows, shape.cols]).astype(np.double)
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorNegative(), -data)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorMinusScaler(randScaler), data - randScaler)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorMinusScalerReversed(randScaler), randScaler - data)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorMinusArray(cArray2), data1 - data2)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorMultiplyScaler(randScaler), data * randScaler)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorMultiplyScalerReversed(randScaler), data * randScaler)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorMultiplyArray(cArray2), data1 * data2)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorDivideScaler(randScaler), data / randScaler)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorDivideScalerReversed(randScaler), randScaler / data)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorDivideArray(cArray2), data1 / data2)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorModulusScaler(randScaler), data % randScaler)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorModulusScalerReversed(randScaler), randScaler % data)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorModulusArray(cArray2), data1 % data2)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorBitwiseOrScaler(randScaler), np.bitwise_or(data, randScaler))
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorBitwiseOrScalerReversed(randScaler), np.bitwise_or(data, randScaler))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorBitwiseOrArray(cArray2), np.bitwise_or(data1, data2))
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorBitwiseAndScaler(randScaler), np.bitwise_and(data, randScaler))
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorBitwiseAndScalerReversed(randScaler), np.bitwise_and(data, randScaler))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorBitwiseAndArray(cArray2), np.bitwise_and(data1, data2))
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorBitwiseXorScaler(randScaler), np.bitwise_xor(data, randScaler))
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorBitwiseXorScalerReversed(randScaler), np.bitwise_xor(data, randScaler))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorBitwiseXorArray(cArray2), np.bitwise_xor(data1, data2))
    ...
    data = np.random.randint(1, 100, [shape.rows, shape.cols]).astype(np.uint32)
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorBitwiseNot(), ~data)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorLogicalAndArray(cArray2), np.logical_and(data1, data2))
    ...
    assert np.array_equal(cArray.operatorLogicalAndScalar(randScalar), np.logical_and(data, randScalar))
    ...
    cArray.setArray(data)
    randScalar = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorLogicalAndScalarReversed(randScalar), np.logical_and(data, randScalar))
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorLogicalOrArray(cArray2), np.logical_or(data1, data2))
    ...
    cArray.setArray(data)
    randScalar = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorLogicalOrScalar(randScalar), np.logical_or(data, randScalar))
    ...
    cArray.setArray(data)
    randScalar = np.random.randint(1, 100, [1, ]).item()
    assert np.array_equal(cArray.operatorLogicalOrScalarReversed(randScalar), np.logical_or(data, randScalar))
    ...
    data = np.random.randint(1, 100, [shape.rows, shape.cols]).astype(np.uint32)
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorNot(), np.logical_not(data))
    ...
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorEquality(value), data == value)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorEqualityReversed(value), data == value)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorEquality(cArray2), data1 == data2)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorNotEquality(value), data != value)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorNotEqualityReversed(value), data != value)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorNotEquality(cArray2), data1 != data2)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorLess(value), data < value)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorLessReversed(value), value < data)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorLess(cArray2), data1 < data2)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorGreater(value), data > value)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorGreaterReversed(value), value > data)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorGreater(cArray2), data1 > data2)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorLessEqual(value), data <= value)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorLessEqualReversed(value), value <= data)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorLessEqual(cArray2), data1 <= data2)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorGreaterEqual(value), data >= value)
    ...
    value = np.random.randint(1, 100, [1, ]).astype(np.uint32).item()
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorGreaterEqualReversed(value), value >= data)
    ...
    cArray1.setArray(data1)
    cArray2.setArray(data2)
    assert np.array_equal(cArray1.operatorGreaterEqual(cArray2), data1 >= data2)
    ...
    assert np.array_equal(cArray.operatorBitshiftLeft(randScaler), data << randScaler)
    ...
    cArray.setArray(data)
    randScaler = np.random.randint(1, 10, [1, ]).item()
    assert np.array_equal(cArray.operatorBitshiftRight(randScaler), data >> randScaler)
    ...
    data = np.random.randint(1, 100, [shape.rows, shape.cols]).astype(np.uint32)
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorPostPlusPlus(), data)
    ...
    data = np.random.randint(1, 100, [shape.rows, shape.cols]).astype(np.uint32)
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorPostMinusMinus(), data)
    assert np.array_equal(cArray.getNumpyArray(), data - 1)
    ...
    data = np.random.randint(1, 100, [shape.rows, shape.cols]).astype(np.uint32)
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorPrePlusPlus(), data + 1)
    ...
    data = np.random.randint(1, 100, [shape.rows, shape.cols]).astype(np.uint32)
    cArray.setArray(data)
    assert np.array_equal(cArray.operatorPreMinusMinus(), data - 1)
